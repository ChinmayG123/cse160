...
function drawing() {
  // ocean
  gl.uniform4f(u_FragColor, 0.3, 0.5, 1.0, g_selectedColor[3]);
  drawTriangle([-1,0,1,-1,-1,-1]);
  drawTriangle([-1,0,1,0,1,-1]);

  // sky
  gl.uniform4f(u_FragColor, 0.8, 0.9, 1.0, g_selectedColor[3]);
  drawTriangle([-1,0,1,0,-1,1]);
  drawTriangle([1,1,1,0,-1,1]);

  // support beam 1
  gl.uniform4f(u_FragColor, 0, 0, 0, g_selectedColor[3]);
  ...
  // fish 1
  gl.uniform4f(u_FragColor, 1, 1, 0, g_selectedColor[3]);
  drawTriangle([0,-0.5, 0.4, -0.2, 0.4, -0.5]);
  drawTriangle([0,-0.5, 0.4, -0.8, 0.4, -0.5]);

  gl.uniform4f(u_FragColor, 0, 1, 0, g_selectedColor[3]);
  drawTriangle([0,-0.5, 0.2, -0.35, 0.2, -0.5]);
  drawTriangle([0,-0.5, 0.2, -0.65, 0.2, -0.5]);

  gl.uniform4f(u_FragColor, 0.7, 0.5, 0.9, g_selectedColor[3]);
  ...
  // red
  gl.uniform4f(u_FragColor, 1, 0.1, 0.1, g_selectedColor[3]);
  ...
  // purple
  gl.uniform4f(u_FragColor, 0, 0, 0.2, g_selectedColor[3]);
  ...
  // green
  gl.uniform4f(u_FragColor, 0, 0.6, 0.2, g_selectedColor[3]);
  ...
  // light purple
  gl.uniform4f(u_FragColor, 0.6, 0.3, 0.8, g_selectedColor[3]);
